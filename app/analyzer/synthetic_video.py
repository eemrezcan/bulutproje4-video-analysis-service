...
def ensure_synthetic_video(
    path: Path,
    title: str = "Smart City Live Camera",
    accent_color: tuple[int, int, int] = (70, 170, 230),
    pedestrian_count: int = 38,
    speed_offset: int = 0,
) -> bool:
    ...
    for frame_no in range(frame_count):
        ...
        sun_x = 80 + (frame_no * (2 + speed_offset % 2)) % width
        cv2.circle(frame, (sun_x, 75), 34, accent_color, -1)
        ...
        for idx in range(pedestrian_count):
